"""Reproducible baseline experiment with no injected communication faults."""
...
def generate_launch_description():
    """Launch the baseline experiment profile."""
    launch_arguments = launch_arguments_for_profile(PROFILE_NAME)
    launch_arguments.update({
        'enable_metrics': 'true',
        'metrics_output_dir': 'experiment_results/baseline',
