"""Reproducible experiment with packet loss injection."""
...
def generate_launch_description():
    """Launch the packet-loss experiment profile."""
    launch_arguments = launch_arguments_for_profile(PROFILE_NAME)
    launch_arguments.update({
        'enable_metrics': 'true',
        'metrics_output_dir': 'experiment_results/loss',
            ...
            parameters=[
                {
                    ...
                    'output_dir': 'experiment_results/loss',
                    **typed_parameters,
                }
            ],
            output='screen',
